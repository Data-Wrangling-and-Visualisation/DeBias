function createSandboxNetwork(options) {
  ...
  function showPublicationModal(nodeData) {
    ...
    aarticlesToShow.slice(0, maxShown).forEach((title) => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function getSandboxSettings() {
    return {
      containerSelector: "#right_network",
      dataUrl: "/api/keywords/graph/?alignment=Lean%20Right;Right&date_from=2025-04-20&date_till=2025-04-20",
      startDate: null,
      endDate: null,
      selectedTopics: [],
      maxNodes: 20,
